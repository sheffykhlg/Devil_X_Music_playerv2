...
from Devil.utils.database import (get_active_chats,
                                       remove_active_chat,
...
async def update_(client, message, _):
    ...
    if verification == "":
        return await response.edit("🌷 𝐃𝐞𝐯𝐢𝐥 𝐁𝐨𝐭 𝐈𝐬 𝐔𝐩-𝐓𝐨-𝐃𝐚𝐭𝐞 🍁 !")
    updates = ""
        ...
        try:
            ...
            for x in served_chats:
                try:
                    ...
                    pass
            await response.edit(
                f"{nrs.text}\n\n💥 𝐃𝐞𝐯𝐢𝐥 𝐁𝐨𝐭 𝐔𝐩𝐝𝐚𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 ✅ ! 𝐍𝐨𝐰 𝐘𝐨𝐮 𝐖𝐚𝐢𝐭 𝐅𝐞𝐰 𝐌𝐢𝐧𝐮𝐭𝐞𝐬 ⏱️"
            )
            os.system(
...
async def restart_(_, message):
    response = await message.reply_text("🥀 𝐃𝐞𝐯𝐢𝐥 𝐁𝐨𝐭 𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐢𝐧𝐠 ✅")
    served_chats = await get_active_chats()
    for x in served_chats:
        try:
            await app.send_message(
