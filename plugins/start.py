...
from Devil.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} 𝐇𝐚𝐬 𝐉𝐮𝐬𝐭 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 𝐃𝐞𝐯𝐢𝐥  𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭 𝐓𝐨 𝐂𝐡𝐞𝐜𝐤 <code>SUDOLIST</code>\n\n**🆔 𝐔𝐬𝐞𝐫 𝐈𝐝:** {sender_id}\n**👑 𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞:** {sender_name}",
                )
            return
        if name[0:3] == "lyr":
        ...
        if name[0:3] == "inf":
            ...
            searched_text = f"""
__**🌷 𝐃𝐞𝐯𝐢𝐥  𝐕𝐢𝐝𝐞𝐨 𝐓𝐫𝐚𝐜𝐤 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧 🌷**__
...
🔍️ 𝐒𝐞𝐚𝐫𝐜𝐡𝐞𝐝 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 🌷 {config.MUSIC_BOT_NAME}__"""
            ...
            if await is_on_off(config.LOG):
                ...
                sender_name = message.from_user.first_name
                return await app.send_message(
                    Devil.config.LOG_GROUP_ID,
                    f"{message.from_user.mention} 𝐇𝐚𝐬 𝐉𝐮𝐬𝐭 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 𝐃𝐞𝐯𝐢𝐥 ✘ 𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭 🎵  𝐓𝐨 𝐂𝐡𝐞𝐜𝐤 <code>🥀 𝐕𝐢𝐝𝐞𝐨 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧</code>\n\n**🆔 𝐔𝐬𝐞𝐫 𝐈𝐝:** {sender_id}\n**👑 𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞:** {sender_name}",
                )
    else:
        try:
        ...
        photo=f"https://te.legra.ph/file/490d4f6fa16e4bdff4c0c.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 𝐇𝐞𝐥𝐥𝐨, 𝐈 𝐚𝐦 𝐒𝐮𝐩𝐞𝐫𝐟𝐚𝐬𝐭 𝐇𝐢𝐠𝐡 𝐐𝐮𝐚𝐥𝐢𝐭𝐲
𝐍𝐨 𝐋𝐚𝐠 𝐕𝐂 𝐌𝐮𝐬𝐢𝐜 𝐏𝐥𝐚𝐲𝐞𝐫 𝐁𝐨𝐭.

┏━━━━━━━━━━━━━━━━━┓
┣★ 𝐎𝐰𝐧𝐞𝐫😈 : [🇲​.𝐑 𝐃𝐄𝐕𝐈𝐋](https://t.me/misterjack18)
┣★ 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 » : [𝐃𝐞𝐯𝐢𝐥 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥](https://t.me/Teams_devil)
┣★ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 » : [𝐃𝐞𝐯𝐢𝐥 𝐂𝐡𝐚𝐭](https://t.me/sabyahaapnehai)
┗━━━━━━━━━━━━━━━━━┛
...
━━━━━━━━━━━━━━━━━━━━━━━━**""",
    reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📺 ❰ 𝐏𝐫𝐨𝐦𝐨𝐭𝐢𝐨𝐧 ❱ 📺", url=f"https://www.youtube.com/@Teams_devil"),
                ],
                [
                    InlineKeyboardButton(
...
━━━━━━━━━━━━━━━━━━━━━━━━**""",
    reply_markup=InlineKeyboardMarkup(
        ...
        if await is_on_off(config.LOG):
            ...
            return await app.send_message(
                config.LOG_GROUP_ID,
                f"{message.from_user.mention} 𝐇𝐚𝐬 𝐉𝐮𝐬𝐭 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 𝐃𝐞𝐯𝐢𝐥 ✘ 𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭 🌷.\n\n**🆔 𝐔𝐬𝐞𝐫 𝐈𝐝:** {sender_id}\n**👑 𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞:** {sender_name}",
            )
...
async def testbot(client, message: Message, _):
    ...
    return await message.reply_text(
        "**✅ 𝐓𝐡𝐚𝐧𝐤 𝐘𝐨𝐮 𝐅𝐨𝐫 𝐔𝐬𝐢𝐧𝐠 𝐌𝐞 𝐈𝐧\n𝐂𝐡𝐚𝐭 »  {0}\n\n🥀 𝐈𝐟 𝐘𝐨𝐮 𝐇𝐚𝐯𝐞 📀 𝐀𝐧𝐲 𝐐𝐮𝐞𝐫𝐢𝐞𝐬\n𝐓𝐡𝐞𝐧 𝐄𝐱𝐩𝐥𝐚𝐢𝐧 💬 𝐓𝐨 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 👑.\n\n💐 𝐉𝐨𝐢𝐧 𝐎𝐮𝐫 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 ‖ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 🌷\n🌷 𝐅𝐨𝐫 𝐆𝐞𝐭𝐭𝐢𝐧𝐠 𝐍𝐞𝐰 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 💞...**".format(
            message.chat.title, Devil.config.MUSIC_BOT_NAME
        ),
...
async def welcome(client, message: Message):
    ...
    for member in message.new_chat_members:
        try:
            ...
            if member.id in Devil.config.OWNER_ID:
                return await message.reply_text(
                    _["start_4"].format(
