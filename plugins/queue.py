...
from Devil.utils import (Devillbin, get_channeplayCB,
                              seconds_to_min)
from Devil.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from Devil.utils.decorators.language import language, languageCB
from Devil.utils.inline import queue_back_markup, queue_markup
...
async def queue_back(client, CallbackQuery: CallbackQuery, _):
    ...
    cap = f"""**𝐃𝐞𝐯𝐢𝐥  {config.MUSIC_BOT_NAME} 𝐏𝐥𝐚𝐲𝐞𝐝**
